...
import random
from models.networks import BodyNet, Transformer, MLP, SoftBiasTransformer, BodyTransformer, Graph_Module
...
from robomimic.utils.file_utils import Dataset
...
flags.DEFINE_integer('ndemos', 50, 'Number of demonstrations to use for training')
flags.DEFINE_integer('nepochs', 15, 'Number of epochs to train the model')
...
def main(_):
    ...
    if FLAGS.network_type == 'mlp':
        ...
        embedding_dim *= nheads
        net = Graph_Module(input_dim=embedding_dim, dim_feedforward=dim_feedforward, nhead=nheads, num_layers=FLAGS.nlayers)
        print("Graph Module")
